...
public partial class LramirezProyectoNcapasIdentityCoreContext : DbContext
{
    public LramirezProyectoNcapasIdentityCoreContext()
    {
    }

    public LramirezProyectoNcapasIdentityCoreContext(DbContextOptions<LramirezProyectoNcapasIdentityCoreContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.; Database=LRamirezProyectoNCapasIdentityCore; TrustServerCertificate=True; Trusted_Connection=True; User ID=sa; Password=pass@word1;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Area>(entity =>
        {
            entity.HasKey(e => e.IdArea).HasName("PK__Area__2FC141AAD8794F94");
        ...
        {
            entity.HasKey(e => e.IdDepartamento).HasName("PK__Departam__787A433D4288DC4F");
        ...
        modelBuilder.Entity<Producto>(entity =>
        {
            ...
            entity.HasOne(d => d.IdDepartamentoNavigation).WithMany(p => p.Productos)
                ...
                .HasConstraintName("FK__Producto__IdDepa__2F10007B");
        ...
        {
            entity.HasKey(e => e.IdProveedor).HasName("PK__Proveedo__E8B631AF59AE95C3");
